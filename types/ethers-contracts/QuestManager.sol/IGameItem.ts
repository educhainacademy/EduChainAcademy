...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../common.js"
  ...
  export interface IGameItemInterface extends Interface {
  ...
  export interface IGameItem extends BaseContract {
    
    connect(runner?: ContractRunner | null): IGameItem;
    waitForDeployment(): Promise<this>;

    interface: IGameItemInterface;
